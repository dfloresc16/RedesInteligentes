 ...
 */
@Entity
@Table(name = "usuariosvlr")
public class UsuariosVLR {
	@Id
	 ...
	 * @param estadoVlr
	 */
	public UsuariosVLR(String idUsuario, String numeroAbonado, String imei, Integer mnc, Integer tipoPlan,
	...
	public String toString() {
		return "UsuariosVLR [idUsuario=" + idUsuario + ", numeroAbonado=" + numeroAbonado + ", imei=" + imei + ", mnc="
